...
<nav class="navbar navbar-expand-lg navbar-custom">
  <div class="container-fluid">
    <img src="{{asset('images/logo.jpg')}}" class="img-fluid me-4" style="width: 100px; border-radius:50%;" alt="">
    <a class="navbar-brand text-white" href="#" style="font-weight: bold; font-size:25px;">SD BINA BANGSA <br>SURABAYA </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="#">KOPERASI</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="#">KEANGGOTAAN</a>
        </li>
      </ul>
    </div>
  </div>
...
<section class="page1">
  {{ Auth::user()->name }}
    <div id="carouselExampleIndicators" class="carousel slide w-100 mt-4" data-bs-ride="true">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-lg-4 mb-4">
        <h2 class="fw-bold fs-4">SD BINA BANGSA <br>SURABAYA </h2>
...
<footer class="footer-custom">
  <div class="container pt-3 pb-3">
    <div class="row">
      <div class="col">
        <img src="{{asset('images/logo.jpg')}}" class="img-fluid me-4" style="width: 120px; border-radius:50%;" alt="">
      </div>
      <div class="col mt-3">
      ...
      <div class="col">
        <h5>MEDIA SOSIAL :</h5>
        <img src="{{asset('images/wa.png')}}" class="img-fluid me-4" style="width: 50px;" alt="">
        <img src="{{asset('images/ig.png')}}" class="img-fluid me-4" style="width: 30px;" alt="">
        <img src="{{asset('images/yt.png')}}" class="img-fluid me-4" style="width: 30px;" alt="">
      </div>
    </div>
  </div>
</footer>
