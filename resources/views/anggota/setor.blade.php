...
<head>
    ...
    <title>Anggota | Setor Tabungan</title>
            ...
            <div class="col-2 p-0">
                <nav class="nav flex-column navbar-red text-center">
                    ...
                    <div class="nav-link-container text-start">
                        ...
                        <a class="nav-link bg-light" style="color: #BB2A33;" href="/setor">Setoran Tabungan</a>
            ...
            <div class="konten">
                ...
                <div class="Modal ps-4 pt-3">
                    <table>
                        ...
                        <tr>
                            <td>Metode Setoran</td>
                            <td> : </td>
                            <td><input type="text" placeholder="Masukkan disini"></td>
                        </tr>
                        <tr>
                            <td>Laporan Setoran &emsp;</td>
                            <td> : </td>
                            <td><input type="file"></td>
                        </tr>
                        <tr>
                            <td>Konfirmasi Setoran</td>
                            <td> : &emsp;</td>
                            <td><input type="file"></td>
                        </tr>
                    </table>
