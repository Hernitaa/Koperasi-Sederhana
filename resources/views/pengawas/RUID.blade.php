...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-2 p-0">
                <nav class="nav flex-column navbar-red text-center">
                    ...
                    <div class="nav-link-container text-start">
                        ...
                        <a class="nav-link bg-light" style="color:#BB2A33;" href="/RUID">RUID Pengurus</a>
            ...
            <h4 class="mb-2 mt-3"><b>RUID Pengurus</b></h4>
            <img src="{{asset('images/RUID.jpg')}}" alt="">
            </div>
        </div>
    </div>
    </div>
