...
<head>
    ...
    <title>Pengawas | Perubahan</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-2 p-0">
                <nav class="nav flex-column navbar-red text-center">
                    ...
                    <div class="nav-link-container text-start">
                        ...
                        <a class="nav-link bg-light" style="color:#BB2A33;" href="/perubahan">Perubahan Modal</a>
            ...
            <h4 class="mb-2 mt-3"><b>Profil Dewan Pengawas</b></h4>
                ...
                <h5 class="mb-2 mt-5"><b>Perubahan Modal </b></h5>
                <div class="Modal ps-4 pt-3">
                <img src="{{asset('images/perubahan.jpg')}}" style="width:850px;" alt="">
                </div>
            </div>
            </div>
        </div>
