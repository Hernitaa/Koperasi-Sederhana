            ...
            <div class="col-2 p-0">
                <nav class="nav flex-column navbar-red text-center">
                    ...
                    <div class="nav-link-container text-start">
                        ...
                        <a class="nav-link bg-light" style="color:#BB2A33;" href="/aset">Aset dan Inventaris</a>
            ...
            <center>
                <div class="info pt-3">
                    ...
                    <div class="row">
                        ...
                        <a class="btn" style="background-color: #97BE5A;" href="">Simpan</a>
                    </div>
                </div>
            </center>
            </div>
