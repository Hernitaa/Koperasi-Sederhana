  ...
  <div class="container-fluid">
    ...
    <div class="log px-3 py-3">
        ...
        <form action="/create" method="POST">
            ...
            <input type="text" value="{{ Session::get('name')}}" name="name" placeholder="   Nama" required autocomplete="off">
            </div>
            <div class="field mb-4">
            ...
            <center>
                <div class="row">
                    <button onclick="register()" type="submit" name="submit" class="btn rounded-5 ms-5 me-5 w-25" style="background-color: #97BE5A;">Register</button>
                    <a class="btn rounded-5 me-5 ms-auto w-25" style="background-color: #97BE5A;" href="/login">Sign In</a>
                </div>
            </center>
        </form>
    </div>
